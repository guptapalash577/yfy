...
export schema=yfy_db
export PATCH_DIR=/home/palash/work_space/YfY/db

export EMAIL="guptapalash577@gmail.com"
...
if [ -f installedpatches.txt ];
 then echo "installedpatches.txt exists!!"
      ...
      mysql -u $username --password=$password $schema -e "select CONCAT(patch_name,',',status) from tbl_installed_patches;" >> $OUTPUT_FILE
fi
